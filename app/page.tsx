  ...
  return (
    <div >
      ...
      <div className="h-[400] w-[1349] bg-slate-200  p-7  ">
        ...
        <div className="bg-white grid grid-cols-1 justify-between text-center h-[320] w-[1273] py-10 mt-3 ml-2">
          <div>
          ...
          <div className="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mb-10 mt-14 flex flex-row gap-1 ml-[40%] ">
